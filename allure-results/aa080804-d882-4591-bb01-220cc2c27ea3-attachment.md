...
- Name: smoke.spec.js >> TC011: Visual testing on Playwright with toHaveScreenshot
- Location: tests\smoke.spec.js:253:5
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Snapshot: playwright.png

Call log:
  - Expect "toHaveScreenshot(playwright.png)" with timeout 5000ms
