...
```ts
  957  | // test.beforeEach(async ({ page }) => {
  958  | //     logger.info("Test case execution started");
  959  | //     await page.goto("https://www.saucedemo.com/");
  960  | // });
  961  | 
...
> 1057 |     await page.getByTestId('username').fill(sauceDemoData.validUser.username);
       |                                                                     ^ TypeError: Cannot read properties of undefined (reading 'username')
