...
- Name: smoke.spec.js >> TC031: Drag & drop using Playwright
- Location: tests\smoke.spec.js:690:5
...
Locator:  locator('#droppable:visible')
Expected: "Dropped!"
Received: "Drop Here"
Timeout:  5000ms

Call log:
  - Expect "toHaveText" locator('#droppable:visible') with timeout 5000ms
  - waiting for locator('#droppable:visible')
    14 × locator resolved to <div id="droppable" class="drop-box ui-droppable">…</div>
